...
<body>
	...
	<h4>
		...
		value 中的 / 代表的是当前 WEB 应用的根目录. 生成的 url 会自动加上 contextPath ，变成 WEB 绝对路径 
	</h4>
	...
	<h4>c:set: 可以为域对象赋属性值, 其中 value 属性支持 EL 表达式; 还可以为域对象中的 JavaBean 的属性赋值, target, value都支持 EL 表达式</h4>
